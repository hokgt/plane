...
export const WORKSPACE_SETTINGS = {
  ...
  "user-management": {
    key: "user-management",
    i18n_label: "workspace_settings.settings.user_management.title",
    href: `/settings/user-management`,
    access: [EUserWorkspaceRoles.ADMIN, EUserWorkspaceRoles.MEMBER],
    highlight: (pathname: string, baseUrl: string) => pathname === `${baseUrl}/settings/user-management/`,
  },
};
...
export const WORKSPACE_SETTINGS_LINKS: {
  ...
  WORKSPACE_SETTINGS["user-management"],
];
...
export const WORKSPACE_SIDEBAR_DYNAMIC_NAVIGATION_ITEMS: Record<string, IWorkspaceSidebarNavigationItem> = {
  ...
  "user-management": {
    key: "user_management",
    labelTranslationKey: "user_management",
    href: `/user-management/`,
    access: [EUserWorkspaceRoles.ADMIN, EUserWorkspaceRoles.MEMBER, EUserWorkspaceRoles.GUEST], // Temporarily visible to all
  },
};
